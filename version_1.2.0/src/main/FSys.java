...
public class FSys {
	...
	@XmlTransient
	private final HashMap<Integer, Node> nodeIndex = new HashMap<>();
	@XmlTransient
	private final HashMap<Integer, ArrayList<Node>> relationIndex = new HashMap<>();
	...
	public void display(PApplet p5) {		if (App.UPDATE_PHYSVAL) update();	}
	...
	public final HashMap<Integer, Node> getNodeIndex() { return nodeIndex; }
	...
	//	public final ArrayList<Relation> getRelations() { return relations; }
	...
	public static class Node {
		...
		public int color = 0;
		@XmlAttribute
		public final float x = 900;
		@XmlAttribute
		public final float y = 450;
		@XmlTransient
		public Vec2D pos = new Vec2D(x, y);
		@XmlTransient
		public final VerletParticle2D verlet = new VerletParticle2D(pos);
		@XmlTransient
		public final AttractionBehavior2D behavior = new AttractionBehavior2D(verlet, size, -1.2f);
		@XmlTransient
