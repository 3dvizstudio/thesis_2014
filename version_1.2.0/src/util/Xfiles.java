...
class Xfiles {
	private final ArrayList<FSys.Node> nodes = new ArrayList<>();
	private final ArrayList<FSys.Relation> relations = new ArrayList<>();
	private final HashMap<FSys.Node, String> map = new HashMap<>();
	public Xfiles() {	}
